...
import { tariffsDescription } from '@/lib/data'
  ...
  return (
    ...
    >
      <div className='grid gap-6 md:grid-cols-2'>
        {tariffsDescription.map(({ id, price }) => {
          const name = t(`${id}.name`)
          const shortInfo = t(`${id}.shortInfo`)
          const fullInfo = t(`${id}.fullInfo`, { returnObjects: true }) as (
            | string
            | string[]
          )[]
